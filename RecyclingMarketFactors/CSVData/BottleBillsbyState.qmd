...
<qgis version="3.42.3-Münster">
  <identifier>Bottle_Bills_by_State</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>Bottle_Bills_by_State</title>
  <abstract>n America Recycles Day, 2020, the U.S. Environmental Protection Agency (EPA) announced a National Recycling Goal to increase the U.S. recycling rate of materials generated in municipal solid waste (MSW), by weight, to 50 percent by 2030. To further this goal and support the building of new recycling infrastructure through the Bipartisan Infrastructure Law (BIL), EPA is developing a map displaying estimated generation of recyclable materials, estimated recycled quantities, existing recycling infrastructure, and potential recycling end markets to facilitate a needs analysis and better understand where funding could be allocated to enhance markets.
The bottle bill layer is sourced from the Container Recycling Institute’s Bottle Bill Resource Guide. For each state, we provide information on whether the state has a bottle bill, the deposit prices for aluminum, glass, and PET, and notes on the materials accepted. States that do not have bottle bills are grayed out in the layer. 
...
Bottle Bills and Landfill Tipping Fees by State - EPA Office of Land and Emergency Management</abstract>
