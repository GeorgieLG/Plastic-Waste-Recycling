...
<qgis version="3.42.3-Münster">
  <identifier>Landfill_Tipping_Fee_by_State</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>Landfill_Tipping_Fee_by_State</title>
...
Landfill tipping fees are sourced from the annual Environmental Research &amp; Education Foundation (EREF) Analysis of MSW Landfill Tipping Fees 2020 report. We report a single tipping fee for each state. Note that the information included in this map are a snapshot of landfill tipping fees in 2020, and we expect tipping fees to fluctuate over time.
